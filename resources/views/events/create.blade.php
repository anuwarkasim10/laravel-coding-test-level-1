    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-header">
                <h5 class="modal-title" id="create_title">Create Event</h5>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="input-group date " data-provide="datepicker" style="gap: 20px">
                    <div class="flex">
                        <label class="required" for="start">Start At</label>
                        <input type="text" class="form-control datepicker-start" id="start" required>
                    </div>
                    <div class="flex">
                        <label class="required" for="end">End At</label>
                        <input type="text" class="form-control datepicker-end" id="end" required>
                    </div>
                </div><br>
            </div>
