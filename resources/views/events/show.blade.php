        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control show_name" value="{{$events->name}}" id="show_name" disabled>
                </div>

                <div class="form-group">
                    <label class="required" for="show_slug">Slug</label>
                    <input type="text" class="form-control show_slug" value="{{$events->slug}}" id="show_slug" disabled>
                </div>
                <div class="input-group date " data-provide="datepicker" style="gap: 20px">
                    <div class="flex">
                        <label class="required" for="show_start">Start At</label>
                        <input type="text" class="form-control datepicker-start" value="{{$events->start_at}}" id="show_start" disabled>
                    </div>
                    <div class="flex">
                        <label class="required" for="end">End At</label>
                        <input type="text" class="form-control datepicker-end" value="{{$events->end_at}}" id="show_end" disabled>
                    </div>
                </div><br>
            </div>
